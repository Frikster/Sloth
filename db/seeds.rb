...
dirk = User.create!(email: 'you@example.com', username:'Dirk', password: '123456', profile_pic_url: 'https://s3-us-west-1.amazonaws.com/app-academy-sloth-seed/DirkSloth.jpg') 
