  ...
  render() {
    ...
    return (
      <div className='join-channel-form-div'>
        ...
        <ul className='private-channel-form-publicChannel-ul'>
          {publicChannels}
        </ul>
      </div>
    );
